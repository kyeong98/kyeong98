...
button = tk.Button(window, text='*',width=10,height=5, command=lambda: operator_click('*')).grid(column=1,row=4)
button = tk.Button(window, text='/',width=10,height=5, command=lambda: operator_click('/')).grid(column=2,row=4)
button = tk.Button(window, text='%',width=10,height=5, command=lambda: operator_click('%')).grid(column=3,row=4)
######################################################## 5열
button = tk.Button(window, text='**',width=10,height=5, command=lambda: operator_click('**')).grid(column=0,row=5)
button = tk.Button(window, text='√',width=10,height=5, command=lambda: operator_click('√')).grid(column=1,row=5)
######################################################## 6열
button = tk.Button(window, text='=',width=10,height=5, command=calculate).grid(column=3,row=6)
